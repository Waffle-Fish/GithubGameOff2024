...
public class FishingMiniGame : MonoBehaviour
{
  ...
  public List<InventoryItem> ListOfFishCommon;
  public List<InventoryItem> ListOfFishUnCommon;
  public List<InventoryItem> ListOfFishRare;
  ...
  void Start()
  {
    ...
    if (rarityValue <= rarityTable[0])
    {
      ...
      TempItem = ListOfFishCommon[ UnityEngine.Random.Range(0, ListOfFishCommon.Count)];

    }
    else if (rarityValue <= rarityTable[0] + rarityTable[1])
    {
      UnityEngine.Debug.Log("Uncommon");
      TempItem = ListOfFishCommon[ UnityEngine.Random.Range(0, ListOfFishUnCommon.Count)];

    }
    else
    {
      UnityEngine.Debug.Log("rare");
      TempItem = ListOfFishCommon[ UnityEngine.Random.Range(0, ListOfFishRare.Count)];
    }
